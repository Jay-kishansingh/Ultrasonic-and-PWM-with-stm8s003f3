  ...
  62                     ; 53     UART1->BRR2 = UART1_BRR2_RESET_VALUE;  /* Set UART1_BRR2 to reset value 0x00 */
  64  0006 725f5233      	clr	21043
  65                     ; 54     UART1->BRR1 = UART1_BRR1_RESET_VALUE;  /* Set UART1_BRR1 to reset value 0x00 */
  67  000a 725f5232      	clr	21042
  68                     ; 56     UART1->CR1 = UART1_CR1_RESET_VALUE;  /* Set UART1_CR1 to reset value 0x00 */
  70  000e 725f5234      	clr	21044
  71                     ; 57     UART1->CR2 = UART1_CR2_RESET_VALUE;  /* Set UART1_CR2 to reset value 0x00 */
  73  0012 725f5235      	clr	21045
  74                     ; 58     UART1->CR3 = UART1_CR3_RESET_VALUE;  /* Set UART1_CR3 to reset value 0x00 */
  76  0016 725f5236      	clr	21046
  77                     ; 59     UART1->CR4 = UART1_CR4_RESET_VALUE;  /* Set UART1_CR4 to reset value 0x00 */
  79  001a 725f5237      	clr	21047
  80                     ; 60     UART1->CR5 = UART1_CR5_RESET_VALUE;  /* Set UART1_CR5 to reset value 0x00 */
  82  001e 725f5238      	clr	21048
  83                     ; 62     UART1->GTR = UART1_GTR_RESET_VALUE;
  85  0022 725f5239      	clr	21049
  86                     ; 63     UART1->PSCR = UART1_PSCR_RESET_VALUE;
 ...
 401                     ; 83 void UART1_Init(uint32_t BaudRate, UART1_WordLength_TypeDef WordLength, 
 401                     ; 84                 UART1_StopBits_TypeDef StopBits, UART1_Parity_TypeDef Parity, 
 401                     ; 85                 UART1_SyncMode_TypeDef SyncMode, UART1_Mode_TypeDef Mode)
 401                     ; 86 {
 402                     .text:	section	.text,new
 403  0000               _UART1_Init:
 405  0000 520c          	subw	sp,#12
 406       0000000c      OFST:	set	12
 409                     ; 87     uint32_t BaudRate_Mantissa = 0, BaudRate_Mantissa100 = 0;
 413                     ; 90     assert_param(IS_UART1_BAUDRATE_OK(BaudRate));
 ...
 423  0011 ae005a        	ldw	x,#90
 424  0014 cd01b5        	call	LC001
 425  0017               L41:
 426                     ; 91     assert_param(IS_UART1_WORDLENGTH_OK(WordLength));
 428  0017 7b13          	ld	a,(OFST+7,sp)
 429  0019 270a          	jreq	L42
 430  001b a110          	cp	a,#16
 431  001d 2706          	jreq	L42
 432  001f ae005b        	ldw	x,#91
 433  0022 cd01b5        	call	LC001
 434  0025               L42:
 435                     ; 92     assert_param(IS_UART1_STOPBITS_OK(StopBits));
 ...
 445  0035 ae005c        	ldw	x,#92
 446  0038 cd01b5        	call	LC001
 447  003b               L43:
 448                     ; 93     assert_param(IS_UART1_PARITY_OK(Parity));
 ...
 456  0047 ae005d        	ldw	x,#93
 457  004a cd01b5        	call	LC001
 458  004d               L44:
 459                     ; 94     assert_param(IS_UART1_MODE_OK((uint8_t)Mode));
 ...
 478  006f ae005e        	ldw	x,#94
 479  0072 cd01b5        	call	LC001
 480  0075               L45:
 481                     ; 95     assert_param(IS_UART1_SYNCMODE_OK((uint8_t)SyncMode));
 ...
 565                     ; 122     BaudRate_Mantissa100 = (((uint32_t)CLK_GetClockFreq() * 100) / (BaudRate << 4));
 ...
 589                     ; 124     UART1->BRR2 |= (uint8_t)((uint8_t)(((BaudRate_Mantissa100 - (BaudRate_Mantissa * 100)) << 4) / 100) & (uint8_t)0x0F); 
 ...
 621                     ; 126     UART1->BRR2 |= (uint8_t)((BaudRate_Mantissa >> 4) & (uint8_t)0xF0); 
 ...
 778                     ; 177 void UART1_Cmd(FunctionalState NewState)
 778                     ; 178 {
 779                     .text:	section	.text,new
 780  0000               _UART1_Cmd:
 784                     ; 179     if (NewState != DISABLE)
 786  0000 4d            	tnz	a
 787  0001 2705          	jreq	L732
 788                     ; 182         UART1->CR1 &= (uint8_t)(~UART1_CR1_UARTD); 
 790  0003 721b5234      	bres	21044,#5
 793  0007 81            	ret	
 794  0008               L732:
 795                     ; 187         UART1->CR1 |= UART1_CR1_UARTD;  
 797  0008 721a5234      	bset	21044,#5
 798                     ; 189 }
 801  000c 81            	ret	
 927                     ; 205 void UART1_ITConfig(UART1_IT_TypeDef UART1_IT, FunctionalState NewState)
 927                     ; 206 {
 ...
 936                     ; 207     uint8_t uartreg = 0, itpos = 0x00;
 940                     ; 210     assert_param(IS_UART1_CONFIG_IT_OK(UART1_IT));
 ...
 954  0020 ae00d2        	ldw	x,#210
 955  0023 ad70          	call	LC006
 956  0025               L401:
 957                     ; 211     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 959  0025 7b07          	ld	a,(OFST+5,sp)
 960  0027 2708          	jreq	L411
 961  0029 4a            	dec	a
 962  002a 2705          	jreq	L411
 963  002c ae00d3        	ldw	x,#211
 964  002f ad64          	call	LC006
 965  0031               L411:
 966                     ; 214     uartreg = (uint8_t)((uint16_t)UART1_IT >> 0x08);
 968  0031 7b03          	ld	a,(OFST+1,sp)
 969  0033 6b01          	ld	(OFST-1,sp),a
 971                     ; 216     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART1_IT & (uint8_t)0x0F));
...
1034  007a               L533:
1035                     ; 241         else if (uartreg == 0x02)
1037  007a a102          	cp	a,#2
1038  007c 260b          	jrne	L143
1039                     ; 243             UART1->CR2 &= (uint8_t)(~itpos);
...
1048  0089               L143:
1049                     ; 247             UART1->CR4 &= (uint8_t)(~itpos);
...
1070  00a0 81            	ret	
1107                     ; 258 void UART1_HalfDuplexCmd(FunctionalState NewState)
1107                     ; 259 {
1108                     .text:	section	.text,new
1109  0000               _UART1_HalfDuplexCmd:
1111  0000 88            	push	a
1112       00000000      OFST:	set	0
1115                     ; 260     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1117  0001 4d            	tnz	a
1118  0002 2711          	jreq	L231
1119  0004 4a            	dec	a
1120  0005 270e          	jreq	L231
1121  0007 ae0104        	ldw	x,#260
...
1129  0015               L231:
1130                     ; 262     if (NewState != DISABLE)
1132  0015 7b01          	ld	a,(OFST+1,sp)
1133  0017 2706          	jreq	L363
1134                     ; 264         UART1->CR5 |= UART1_CR5_HDSEL;  /**< UART1 Half Duplex Enable  */
1136  0019 72165238      	bset	21048,#3
1138  001d 2004          	jra	L563
1139  001f               L363:
1140                     ; 268         UART1->CR5 &= (uint8_t)~UART1_CR5_HDSEL; /**< UART1 Half Duplex Disable */
1142  001f 72175238      	bres	21048,#3
1143  0023               L563:
1144                     ; 270 }
1147  0023 84            	pop	a
1148  0024 81            	ret	
1206                     ; 278 void UART1_IrDAConfig(UART1_IrDAMode_TypeDef UART1_IrDAMode)
1206                     ; 279 {
1207                     .text:	section	.text,new
1208  0000               _UART1_IrDAConfig:
1210  0000 88            	push	a
1211       00000000      OFST:	set	0
1214                     ; 280     assert_param(IS_UART1_IRDAMODE_OK(UART1_IrDAMode));
1216  0001 a101          	cp	a,#1
1217  0003 2711          	jreq	L441
1218  0005 4d            	tnz	a
1219  0006 270e          	jreq	L441
1220  0008 ae0118        	ldw	x,#280
...
1305  0015               L651:
1306                     ; 304     if (NewState != DISABLE)
1308  0015 7b01          	ld	a,(OFST+1,sp)
1309  0017 2706          	jreq	L734
1310                     ; 307         UART1->CR5 |= UART1_CR5_IREN;
1312  0019 72125238      	bset	21048,#1
1314  001d 2004          	jra	L144
1315  001f               L734:
1316                     ; 312         UART1->CR5 &= ((uint8_t)~UART1_CR5_IREN);
1318  001f 72135238      	bres	21048,#1
1319  0023               L144:
1320                     ; 314 }
1323  0023 84            	pop	a
1324  0024 81            	ret	
1384                     ; 323 void UART1_LINBreakDetectionConfig(UART1_LINBreakDetectionLength_TypeDef UART1_LINBreakDetectionLength)
1384                     ; 324 {
1385                     .text:	section	.text,new
1386  0000               _UART1_LINBreakDetectionConfig:
1388  0000 88            	push	a
1389       00000000      OFST:	set	0
1392                     ; 325     assert_param(IS_UART1_LINBREAKDETECTIONLENGTH_OK(UART1_LINBreakDetectionLength));
1394  0001 4d            	tnz	a
1395  0002 2711          	jreq	L071
1396  0004 4a            	dec	a
1397  0005 270e          	jreq	L071
1398  0007 ae0145        	ldw	x,#325
...
1406  0015               L071:
1407                     ; 327     if (UART1_LINBreakDetectionLength != UART1_LINBREAKDETECTIONLENGTH_10BITS)
1409  0015 7b01          	ld	a,(OFST+1,sp)
1410  0017 2706          	jreq	L174
1411                     ; 329         UART1->CR4 |= UART1_CR4_LBDL;
1413  0019 721a5237      	bset	21047,#5
1415  001d 2004          	jra	L374
1416  001f               L174:
1417                     ; 333         UART1->CR4 &= ((uint8_t)~UART1_CR4_LBDL);
1419  001f 721b5237      	bres	21047,#5
1420  0023               L374:
1421                     ; 335 }
1424  0023 84            	pop	a
1425  0024 81            	ret	
1461                     ; 343 void UART1_LINCmd(FunctionalState NewState)
1461                     ; 344 {
1462                     .text:	section	.text,new
1463  0000               _UART1_LINCmd:
1465  0000 88            	push	a
1466       00000000      OFST:	set	0
1469                     ; 345     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1471  0001 4d            	tnz	a
1472  0002 2711          	jreq	L202
1473  0004 4a            	dec	a
1474  0005 270e          	jreq	L202
1475  0007 ae0159        	ldw	x,#345
...
1737  0016               L042:
1738                     ; 413     UART1->CR1 &= ((uint8_t)~UART1_CR1_WAKE);
1740  0016 72175234      	bres	21044,#3
1741                     ; 414     UART1->CR1 |= (uint8_t)UART1_WakeUp;
...
1749  0022 84            	pop	a
1750  0023 81            	ret	
1787                     ; 422 void UART1_ReceiverWakeUpCmd(FunctionalState NewState)
1787                     ; 423 {
1788                     .text:	section	.text,new
1789  0000               _UART1_ReceiverWakeUpCmd:
1791  0000 88            	push	a
1792       00000000      OFST:	set	0
1795                     ; 424     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1797  0001 4d            	tnz	a
1798  0002 2711          	jreq	L252
1799  0004 4a            	dec	a
1800  0005 270e          	jreq	L252
1801  0007 ae01a8        	ldw	x,#424
...
1915                     ; 458   return (uint16_t)( (((uint16_t) UART1->DR) | temp ) & ((uint16_t)0x01FF));
...
2140  0023 84            	pop	a
2141  0024 81            	ret	
2175                     ; 520 void UART1_SetGuardTime(uint8_t UART1_GuardTime)
2175                     ; 521 {
2176                     .text:	section	.text,new
2177  0000               _UART1_SetGuardTime:
2181                     ; 523     UART1->GTR = UART1_GuardTime;
2183  0000 c75239        	ld	21049,a
2184                     ; 524 }
2187  0003 81            	ret	
2221                     ; 548 void UART1_SetPrescaler(uint8_t UART1_Prescaler)
2221                     ; 549 {
2222                     .text:	section	.text,new
2223  0000               _UART1_SetPrescaler:
2227                     ; 551     UART1->PSCR = UART1_Prescaler;
2229  0000 c7523a        	ld	21050,a
2230                     ; 552 }
2233  0003 81            	ret	
2377                     ; 560 FlagStatus UART1_GetFlagStatus(UART1_Flag_TypeDef UART1_FLAG)
2377                     ; 561 {
...
2386                     ; 562     FlagStatus status = RESET;
2388                     ; 565     assert_param(IS_UART1_FLAG_OK(UART1_FLAG));
...
2418  0042               L213:
2419                     ; 569     if (UART1_FLAG == UART1_FLAG_LBDF)
2421  0042 1e02          	ldw	x,(OFST+1,sp)
2422  0044 a30210        	cpw	x,#528
2423  0047 2605          	jrne	L1601
2424                     ; 571         if ((UART1->CR4 & (uint8_t)UART1_FLAG) != (uint8_t)0x00)
2426  0049 c65237        	ld	a,21047
2427                     ; 574             status = SET;
2429  004c 2008          	jp	LC009
2430                     ; 579             status = RESET;
2431  004e               L1601:
2432                     ; 582     else if (UART1_FLAG == UART1_FLAG_SBK)
2434  004e a30101        	cpw	x,#257
2435  0051 260b          	jrne	L1701
2436                     ; 584         if ((UART1->CR2 & (uint8_t)UART1_FLAG) != (uint8_t)0x00)
...
2531  0019               L423:
2532                     ; 644     if (UART1_FLAG == UART1_FLAG_RXNE)
2534  0019 1e01          	ldw	x,(OFST+1,sp)
2535  001b a30020        	cpw	x,#32
2536  001e 2606          	jrne	L3211
2537                     ; 646         UART1->SR = (uint8_t)~(UART1_SR_RXNE);
2539  0020 35df5230      	mov	21040,#223
2541  0024 2004          	jra	L5211
2542  0026               L3211:
2543                     ; 651         UART1->CR4 &= (uint8_t)~(UART1_CR4_LBDF);
2545  0026 72195237      	bres	21047,#4
2546  002a               L5211:
2547                     ; 653 }
2550  002a 85            	popw	x
2551  002b 81            	ret	
2634                     ; 668 ITStatus UART1_GetITStatus(UART1_IT_TypeDef UART1_IT)
2634                     ; 669 {
...
2643                     ; 670     ITStatus pendingbitstatus = RESET;
2645                     ; 671     uint8_t itpos = 0;
2647                     ; 672     uint8_t itmask1 = 0;
2649                     ; 673     uint8_t itmask2 = 0;
2651                     ; 674     uint8_t enablestatus = 0;
2653                     ; 677     assert_param(IS_UART1_GET_IT_OK(UART1_IT));
...
2677  0033               L633:
2678                     ; 680     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART1_IT & (uint8_t)0x0F));
...
2694                     ; 682     itmask1 = (uint8_t)((uint8_t)UART1_IT >> (uint8_t)4);
2696  0044 7b04          	ld	a,(OFST+2,sp)
2697  0046 4e            	swap	a
2698  0047 a40f          	and	a,#15
2699  0049 6b02          	ld	(OFST+0,sp),a
2701                     ; 684     itmask2 = (uint8_t)((uint8_t)1 << itmask1);
2703  004b 5f            	clrw	x
